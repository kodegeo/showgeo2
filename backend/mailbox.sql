...
-- CreateEnum
CREATE TYPE "TicketType" AS ENUM ('FREE', 'GIFTED', 'PAID');

-- CreateEnum
CREATE TYPE "TicketStatus" AS ENUM ('ACTIVE', 'USED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "RegistrationStatus" AS ENUM ('INVITED', 'REGISTERED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "MailboxItemType" AS ENUM ('TICKET', 'INVITATION', 'NOTIFICATION', 'EVENT_UPDATE');
...
CREATE TABLE "events" (
    ...
    "phase" "EventPhase" NOT NULL DEFAULT 'PRE_LIVE',
...
-- CreateIndex
CREATE UNIQUE INDEX "event_registrations_accessCode_key" ON "event_registrations"("accessCode");

-- CreateIndex
CREATE INDEX "mailbox_items_userId_idx" ON "mailbox_items"("userId");

-- CreateIndex
CREATE INDEX "mailbox_items_email_idx" ON "mailbox_items"("email");

-- CreateIndex
CREATE INDEX "mailbox_items_registrationId_idx" ON "mailbox_items"("registrationId");
...
-- AddForeignKey
ALTER TABLE "event_registrations" ADD CONSTRAINT "event_registrations_userId_fkey" FOREIGN KEY ("userId") REFERENCES "app_users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_items" ADD CONSTRAINT "mailbox_items_userId_fkey" FOREIGN KEY ("userId") REFERENCES "app_users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mailbox_items" ADD CONSTRAINT "mailbox_items_registrationId_fkey" FOREIGN KEY ("registrationId") REFERENCES "event_registrations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
