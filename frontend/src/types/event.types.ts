/**
 * Frontend-local event types
 * 
 * These types are defined locally to avoid importing from packages/shared
 * which causes Vite build issues with paths outside the frontend directory.
 */
